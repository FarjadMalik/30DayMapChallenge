...
def generate_urban_map(path_dir: str, filename: str):
    """    
    """
    ...
    # -------------------------------------------------------------------------------------- 
    # Feature Engineering: Calculate urban green percentage for each admin unit
    # --------------------------------------------------------------------------------------
    ...
    create_html(admin_gdf, green_urban_gdf, output_path)
    # create_png(admin_gdf, green_urban_gdf, output_path)
...
if __name__ == "__main__":
    ...
    filename = 'urban_green_mapping_pakistan'
    generate_urban_map(path_dir=str(get_relative_path(__file__)), filename=filename)
